...
// En el código se dispone de las cabeceras de todas las funciones a desarrollar
// y una breve explicación de lo que debe realizar.
// Cada alumno programará la/las función/es que le indique el profesor. El resto no las tocará.  
// La única función que ya está hecha es la función main.
// Cada alumno debe realizar unas pruebas mínimas de que su función es correcta.
// ################################################################################
...
public class Buscaminas {
	...
	// ################################################################################
	// Función IncializarTablero: Función que recibe las dos talbas: tablero,
	// visible
	...
	// ################################################################################
	// Función PonerMinas: Función que recibe el tablero (tabla 10x10) por
	// referencia
	...
	// Si es una casilla que se puede destapar (la posición de la tabla visible es
	// Falso)
	...
	// ################################################################################
	// Función ComprobarTablero: Funcion que recibe por referencia las dos tablas y
	// la
	// fila y columna que se debe destapar.
	...
	// Dependiendo del valor de cada posición de la tabla visible, muestra la
	// posición
